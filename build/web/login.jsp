...
<html lang="en">
<head>
<title>Pune University/loginuser/</title>
	...
	<div class="header-top">
		<div class="container">
			<div class="w3layouts-address">
				<ul>
					<li><i class="fa fa-mobile" aria-hidden="true"></i>contact:6868######S</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="skhan.javaexpert@gmail.com">quantum@gmail.com</a></li>
				</ul>
			</div>
